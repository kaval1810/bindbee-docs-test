...
To create a webhook see [Create a Webhook](/how-to/reliability/create-a-webhook); for what each field on the Dashboard screen does see [Webhooks](/platform/webhooks).
