...
<Steps>
  ...
  <Step title="Select events">
    Choose which events to receive - see [Webhook Events & Payloads](/webhooks/events) for what each one does and when it fires.
  </Step>
...
- [Webhook Events & Payloads](/webhooks/events) - the five events and what each payload carries
