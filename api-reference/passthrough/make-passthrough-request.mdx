...
[Passthrough: When & Why](/explanation/passthrough).
...
<CardGroup cols={2}>
  <Card title="Using Passthrough" icon="wrench" href="/how-to/data-model/make-a-passthrough-request">
    Isolating per-vendor code behind an adapter.
  </Card>
  <Card title="When & Why" icon="circle-help" href="/explanation/passthrough">
