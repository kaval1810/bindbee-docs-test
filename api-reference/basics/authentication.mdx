...
- **Magic Link or programmatic link** - there is no temporary token. Look the connector up by the `origin_id` you set, with [Get Connectors](/api-reference/connectors/get-connectors).
...
- [Errors & issues](/guides/troubleshooting/errors-and-issues) - the full status-code list
