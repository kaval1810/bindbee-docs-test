...
| One extra field on a model Bindbee already syncs | **No** - custom field |
| Field exists but is `null` | **No** - [diagnose it first](/concepts/field-semantics) |
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Fields: The Mental Model" icon="git-fork" href="/concepts/custom-fields-mental-model">
