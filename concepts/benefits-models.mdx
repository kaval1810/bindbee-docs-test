...
<Note>
Dependants themselves are not a benefits model. A dependant is a person attached to an employee, and exists whether or not they are covered by anything. Coverage is the dependent benefit; the person is [an employee relation](/concepts/hris-models).
</Note>
...
- [HRIS models](/concepts/hris-models) - where dependants sit, as an employee relation
