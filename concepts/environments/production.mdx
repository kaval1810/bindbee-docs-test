...
See [Environments](/concepts/environments/overview) for what's shared vs. separate between Development and Production, plus how to manage and authenticate with your key.
