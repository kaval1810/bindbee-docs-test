...
Fixing it is a conversation with the customer's admin, not a change on Bindbee's side. See the Go-live checklist.
...
That makes it the only gate you can clear yourself, without touching scope and without asking your customer for anything - map the value as a [custom field](/concepts/custom-fields-mental-model) and it appears on the unified object.
...
<CardGroup cols={2}>
  <Card title="The Unified Model and Raw Data" icon="boxes" href="/concepts/unified-model-and-raw-data">
