...
<AccordionGroup>
  <Accordion title="The write returned 501">
    The Meta schema isn't published for this integration. That is not the same as the write being unsupported - see [Meta APIs](/guides/reading-writing/meta-apis#where-there-is-no-schema).
  </Accordion>
