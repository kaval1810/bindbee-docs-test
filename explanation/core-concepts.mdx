...
A connector's environment is set at creation but can be switched later, without the end user reconnecting - though not from the dashboard. See [Environments](/explanation/environments/overview).
