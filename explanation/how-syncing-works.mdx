...
The trade-off is freshness: the API reflects the most recent sync, not the HRIS at this exact second. See [Data Freshness](/explanation/how-syncing-works) for how sync frequency determines how current that is.
...
See [Field semantics](/explanation/field-semantics) and [Filtering with `modified_after`](/how-to/reading-data/filter-with-modified-after).
...
<CardGroup cols={2}>
  <Card title="Data Freshness & Polling" icon="clock" href="/explanation/how-syncing-works">
    How current is the data, really?
  </Card>
  <Card title="Connector States & Lifecycle" icon="route" href="/explanation/connector-lifecycle">
