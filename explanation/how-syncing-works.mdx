...
The trade-off is freshness: the API reflects the most recent sync, not the HRIS at this exact second. See [Data Freshness](/explanation/data-freshness) for how sync frequency determines how current that is.
