...
For hours worked rather than money paid, see [Reading time & attendance](/explanation/time-and-attendance-models) - the two do not reconcile arithmetically, and [Payroll & time models](/explanation/payroll-and-time-models) explains why.
...
<Steps>
  ...
  <Step title="Read deductions from the per-employee model">
    ...
    Those codes are customer-specific and do not map automatically to benefit plans - the relationship is configuration you establish with the customer and store yourself. See [Reading benefits](/explanation/benefits-models) for the plan side.
...
<AccordionGroup>
  ...
  <Accordion title="Payroll doesn't reconcile with hours worked">
    Expected. Overtime is calculated by rules the timesheet doesn't encode, salaried employees are paid without timesheets at all, and corrections land in a later run than the period they fix. See [Reading time & attendance](/explanation/time-and-attendance-models).
  </Accordion>
</AccordionGroup>
...
- [Time & Attendance](/explanation/time-and-attendance-models) - what was worked, as opposed to what was paid
- [Benefits](/explanation/benefits-models) - the payroll code that joins the two
