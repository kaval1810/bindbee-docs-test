...
The rehire case is the one to design for. Two employee records for one human is not something the API can fix - see [Record identity & duplicates](/explanation/record-identity).
