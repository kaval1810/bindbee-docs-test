...
The rehire case is the one to design for. Two employee records for one human is not something the API can fix - see [Identity & duplicates](/explanation/record-identity).
...
- [Identity & duplicates](/explanation/record-identity) - when a rehire becomes a second record
