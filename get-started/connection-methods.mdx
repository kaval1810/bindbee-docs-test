...
How the customer authorises depends on the integration: most offer OAuth, where they sign in and approve access; others need an API key, token or certificate they generate first; some offer both.
