...
<AccordionGroup>
  ...
  <Accordion title="An employee disappeared instead of going inactive">
    Some platforms stop returning terminated records. That looks identical to a scope or permission change - check [Missing records](/guides/troubleshooting/missing-records) before treating absence as a departure.
  </Accordion>
