...
A connector can still be moved between the two. It keeps its authorisation and every ID you have stored, so nobody reconnects. Switch your calls to the target environment's API key.
