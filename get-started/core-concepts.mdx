...
A few endpoints need only the key, because there is no subject to name: listing connectors, listing integrations, configuring custom fields, reading webhook logs. See [Authentication](/guides/api-basics/authentication).
...
- [Authentication](/guides/api-basics/authentication) - how the two tokens are supplied
