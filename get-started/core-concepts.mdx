...
Two terms carry most of the weight: **an integration is the vendor's system, like BambooHR. A connector is one customer's link to that system.**

Change something at the integration level and it affects every customer on that integration. Change it on the connector and only that one customer is affected.
