...
**Generate a Magic Link or embed the flow.** Create a [Magic Link](/features/magic-link) from Bindbee dashboard and send it to your customer, or use [Bindbee Embed](/how-to/connections/bindbee-embed) so they can connect directly inside your own product.
