...
A unique link your customer opens to authorise access from their system.
  ...
  <Step title="Send it to the customer">
    ...
    **The link expires 7 days after it is created.**
    ...
    <Frame caption="Copy Link hands you the URL to send">
      <img src="/images/get-started/magic-link-url.png" alt="The Bindbee Magic Link dialog showing the generated URL for your customer on link.bindbee.dev, a note reading 'Link will expire in 7 days', and Open Link and Copy Link buttons" style={{ maxWidth: "420px", width: "100%", display: "block", margin: "0 auto" }} />
    </Frame>
  </Step>
...
{/* VERIFY: expiry behaviour. Lifetime is confirmed at 7 days (stated in the Magic Link dialog). Still open: what an end user sees after expiry, and whether a link is single-use or reusable. */}
