  ...
  <Step title="Send it to the customer">
    ...
    **The link expires 7 days after it is created.**
    ...
    <Frame caption="Copy Link hands you the URL to send">
      <img src="/images/get-started/magic-link-url.png" alt="The Bindbee Magic Link dialog showing the generated URL for your customer on link.bindbee.dev, a note reading 'Link will expire in 7 days', and Open Link and Copy Link buttons" style={{ maxWidth: "300px", width: "100%", display: "block", margin: "0 auto" }} />
    </Frame>
  </Step>
