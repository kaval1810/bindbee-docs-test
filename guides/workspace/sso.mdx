...
<AccordionGroup>
  ...
  <Accordion title="A user is in but can't do something they expect to">
    That's their role, not SSO. Deleting a Production connector, the Production API key, SFTP credentials and invitations are Admin-only - see [Roles & permissions](/guides/workspace/roles-and-permissions).
  </Accordion>
