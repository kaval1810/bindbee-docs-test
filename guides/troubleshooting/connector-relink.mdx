...
<Steps>
  ...
  <Step title="Generate a relink">
    ...
    **Result:** A link the customer can open to re-enter credentials against the existing connector.
    ...
    <Frame>
      <img src="/images/platform/connector-relink-needed.png" alt="A connector page showing a Relink Needed banner with the date since it entered that state and a Relink Connector button, a grayed-out Force Sync control, and a sync history whose most recent run is marked Failed" />
    </Frame>
  </Step>
