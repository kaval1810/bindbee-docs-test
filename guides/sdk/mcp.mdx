...
<CardGroup cols={2}>
  <Card title="Install in Cursor" icon="arrow-right" href="cursor://anysphere.cursor-deeplink/mcp/install?name=bindbee-docs&config=eyJ1cmwiOiJodHRwczovL2RvY3MuYmluZGJlZS5kZXYvbWNwIn0%3D">
    One click, no config file.
  </Card>

  <Card title="Install in VS Code" icon="arrow-right" href="https://vscode.dev/redirect/mcp/install?name=bindbee-docs&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fdocs.bindbee.dev%2Fmcp%22%7D">
    One click, no config file.
  </Card>
</CardGroup>
