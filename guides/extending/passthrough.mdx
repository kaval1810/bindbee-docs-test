...
<Warning>
  In passthrough, you directly interact with the HRIS API, not Bindbee's. Responses are **not normalized**, and `path` is vendor-specific. Consult the vendor's documentation.
