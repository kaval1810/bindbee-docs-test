...
<Note>
  One naming quirk to know about: the [configuration endpoint](/guides/extending/custom-fields/api-workflow#step-6-verify-the-effective-configuration) reports an integration level mapping as `"source": "organization"`. It is the same mapping type under an older name.
</Note>
