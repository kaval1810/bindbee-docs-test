...
You can watch its progress on the connector. This endpoint scopes by a **query parameter**, not the usual header:
...
See [Environments](/get-started/environments) for everything else the two differ on.
