...
The employee model is the entry point for most integrations. This page covers what's specific to it - for the general techniques, see [Pagination](/guides/api-basics/pagination) and [Filtering](/guides/reading-writing/querying-data).
