...
<AccordionGroup>
  <Accordion title="Time off or timesheets return nothing">
    Time and attendance is commonly a separately licensed module with its own permission grant, and an empty result is the usual failure here, not an error. See [Permission errors](/guides/troubleshooting/permission-errors).
  </Accordion>
