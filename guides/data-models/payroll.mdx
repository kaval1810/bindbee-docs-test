...
<AccordionGroup>
  <Accordion title="Payroll returns nothing though the customer runs payroll">
    Payroll is usually a separately licensed module with its own permission grant, and an empty result is the common failure here, not an error. See [Permission errors](/guides/troubleshooting/permission-errors).
  </Accordion>
...
- [Employee & org data](/guides/data-models/employee-and-org) - where `pay_frequency` and pay group references live
