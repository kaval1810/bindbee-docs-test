...
The general techniques are the same as HRIS - see [Pagination](/api-reference/basics/pagination) and [Querying data](/guides/reading-writing/querying-data). What follows is specific to ATS.
...
- [Write support](/guides/reading-writing/meta-apis) - what ATS lets you create
