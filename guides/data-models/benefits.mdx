...
<AccordionGroup>
  <Accordion title="Benefits return nothing though the customer has enrolments">
    Most often it's a permissions issue - benefits are frequently a separately licensed module with its own access grant, and several platforms return an empty set rather than an error. See [Origin-system errors](/guides/troubleshooting/errors#origin-system-errors).
...
- [Employee & org data](/guides/data-models/employee-data) - where dependants live
