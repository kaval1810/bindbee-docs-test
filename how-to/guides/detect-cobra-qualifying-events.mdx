...
<Steps>
  <Step title="Subscribe to both change events">
    `employee_data_changed` covers status and employment; `connector_data_modified` covers the other models, including dependents - see [Choose Webhook Events](/webhooks/events).
