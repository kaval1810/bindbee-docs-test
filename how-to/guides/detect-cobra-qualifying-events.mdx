...
<Steps>
  <Step title="Subscribe to both change events">
    `employee_data_changed` covers status and employment; `connector_data_modified` covers the other models, including dependents - see [Choose Webhook Events](/webhooks/overview).
  ...
  <Step title="Find who else loses coverage">
    ...
    A dependent record means the employee recorded that person; a dependent benefit means they were actually enrolled - see [Reading benefits](/explanation/benefits-models).
...
- [Choose Webhook Events](/webhooks/overview)
