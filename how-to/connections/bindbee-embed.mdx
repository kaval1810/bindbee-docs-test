...
<Warning>
  ...
  Learn more about [Development](/how-to/setup/environments/development) and [Production](/how-to/setup/environments/production) environments.
</Warning>
...
To get the category and Integration name refer to [Integrations](/integrations) page
