...
<Steps>
  <Step title="Open the connector">
    Find it under **Connectors** and open its page - see [Connectors](/platform/connectors).
...
- [Connector lifecycle](/explanation/connector-lifecycle) - what relinking and deleting each do to synced data
