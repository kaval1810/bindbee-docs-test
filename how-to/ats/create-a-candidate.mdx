...
<Info>
  **Before you start**
  ...
  - You have confirmed the integration supports candidate writes - see [Check write support](/explanation/how-meta-apis-work). Probe `GET /api/ats/v1/candidates/create/meta`.
...
<Steps>
  <Step title="Fetch the write schema">
    ...
    Build the body from this rather than hardcoding it - required fields differ per integration, and a required `integration_params` block means the write needs platform-specific values you must source first. See [Fetch a schema](/explanation/how-meta-apis-work).
...
- [Check write support](/explanation/how-meta-apis-work)
...
- [Candidates & applications](/explanation/ats-models)
