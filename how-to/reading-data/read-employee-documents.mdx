...
<Warning>
  Documents is **BETA**. It works, but field names and shapes are not yet frozen - see [Unified model & raw data](/explanation/unified-model).
</Warning>
...
- [Employee & org models](/explanation/employee-and-org-models) - the employee cluster Documents belongs to
