...
<Info>
  **Before you start**
  ...
  - The model is in scope for your organisation - see [Restrict what syncs](/how-to/data-model/restrict-models-and-fields). Documents holds personal tax data, so it is worth an explicit decision rather than a default.
</Info>
...
- [Restrict what syncs](/how-to/data-model/restrict-models-and-fields) - deciding whether to sync it at all
