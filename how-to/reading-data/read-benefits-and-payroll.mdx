...
For anything the unified model does not carry, check `include_raw_data=true` first, then reach for a [custom field](/how-to/data-model/map-custom-fields) or [passthrough](/how-to/writing-data-back/make-a-passthrough-request).
