---
title: "Read Payroll Data"
description: "Fetch pay runs, per-employee earnings and deductions, and the calendar of upcoming runs - and pick the right date filter for each."
---
...
For hours worked rather than money paid, see [Read Time and Attendance Data](/how-to/reading-data/read-time-and-attendance-data) - the two do not reconcile arithmetically, and [Payroll & time models](/explanation/payroll-and-time-models) explains why.
...
<AccordionGroup>
  ...
  <Accordion title="Payroll doesn't reconcile with hours worked">
    Expected. Overtime is calculated by rules the timesheet doesn't encode, salaried employees are paid without timesheets at all, and corrections land in a later run than the period they fix. See [Read Time and Attendance Data](/how-to/reading-data/read-time-and-attendance-data).
  </Accordion>
</AccordionGroup>

## Related

- [Payroll & time models](/explanation/payroll-and-time-models) - why the two halves don't join
...
- [Get Payroll Run Calendars](/hris/payroll-run-calendar/get-payroll-run-calendars) · [Get Payroll Codes](/hris/payroll-codes/get-payroll-codes) · [Get Pay Groups](/hris/pay-groups/get-pay-groups)
