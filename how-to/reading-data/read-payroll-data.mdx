...
For hours worked rather than money paid, see [Read Time and Attendance Data](/how-to/reading-data/read-time-and-attendance-data) - the two do not reconcile arithmetically, and [Payroll & time models](/concepts/payroll-and-time-models) explains why.
...
- [Payroll & time models](/concepts/payroll-and-time-models) - why the two halves don't join
