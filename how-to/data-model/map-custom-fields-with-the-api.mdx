...
sidebarTitle: "Map Fields with the API"
...
<Steps>
  ...
  <Step title="Inspect the raw payload">
    ...
    See [Inspect the Raw Upstream Payload](/how-to/data-model/inspect-the-raw-upstream-payload) for reading the response and building an expression.

    **Result:** A candidate JMESPath.
  </Step>

  <Step title="Validate before persisting">
    Dry-run the expression - see [Test a JMESPath Before Saving It](/how-to/data-model/test-a-jmespath). Skipping this is how `INVALID_JSON_PATH` reaches production responses.
