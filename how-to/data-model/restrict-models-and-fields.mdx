...
<Steps>
  ...
  <Step title="Apply the scope">
    In the Dashboard, go to **Configure → Scoping** and select the models and fields to keep. See [Scoping](/platform/scoping) for what the screen shows.
...
- [Scoping](/platform/scoping) - the Dashboard screen
