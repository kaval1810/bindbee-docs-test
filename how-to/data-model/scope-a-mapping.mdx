...
<Info>
  **Before you start**
  ...
  - You have a custom field created - see [Map with the API](/how-to/data-model/map-custom-fields-with-the-api).
</Info>
...
<Steps>
  ...
  <Step title="Verify against more than one connector">
    ...
    Preview the expression against several connectors before assuming an org mapping holds - see [Test an expression](/how-to/data-model/test-a-jmespath).
