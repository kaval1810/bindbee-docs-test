...
<Steps>
  <Step title="Subscribe to Sync completed">
    Select **Sync completed** on your webhook. Add **Sync error** too - you want to know when a run fails as well as when it succeeds. See [Choose Webhook Events](/how-to/reliability/choose-webhook-events).
