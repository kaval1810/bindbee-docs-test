...
<AccordionGroup>
  ...
  <Accordion title="A record you'd seen classifies as created">
    Check what you're keying on. If it's `remote_id` or employee number, an upstream identifier change breaks the match - some systems reissue these on rehire, transfer, or record merge. See [Unexpected records](/how-to/troubleshooting/trace-an-unexpected-record).
  </Accordion>
...
- [Events & payloads](/webhooks/overview)
