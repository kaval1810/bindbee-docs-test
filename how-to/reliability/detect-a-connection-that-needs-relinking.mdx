...
<AccordionGroup>
  ...
  <Accordion title="Events arrive intermittently">
    ...
    If your handler does work before responding, it will exceed the timeout under load. Acknowledge with `200` immediately and process asynchronously. Deliveries that exhaust all retries are not redelivered later - see [Recover a Missed Webhook Delivery](/webhooks/delivery).
  </Accordion>
